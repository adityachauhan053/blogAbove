...
use App\SocialAccountGoogle;
use App\User;

class GoogleController extends Controller
{
	public function googleLogin(Request $request,SocialAccountGoogle $SocialAccountGoogle)  {
                ...
                $guser = $google_oauthV2->userinfo->get();
                    ...
                    if ($user =User::where('email',$guser['email'])->first()){
						...
						return redirect()->to('/home');
						 ...
						 $user= $SocialAccountGoogle->createOrGetUser($guser);
						  auth()->login($user);
						  return redirect()->to('/home');
					}
